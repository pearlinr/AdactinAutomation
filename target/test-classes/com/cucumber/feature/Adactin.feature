...
Then Login to the application using username "Della2018" and password "emmu@26" as in test data
...
And  Click on Search button
And Verify that hotel "Hotel Creek" displayed is the same as selected in search Hotel form
...
And  Click on Search button
Then Select the booking and click continue button
And Check whether all details are disabled
...
And Verify that the relevant details are displayed
